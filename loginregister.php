...
<!---LOGIN--->
			<form action="backend/login.php" method="POST" id="login" class="input-group" onsubmit="return loginValidate()">
				<input type="text" name="email" id="email" class="input-field" placeholder="Email">
				<input type="password" name="password" id="pw" class="input-field" placeholder="Fjalekalimi"></br>
				<button type="submit" name= "submit" class="submit-btn" onclick="validimi(0)"> Log in</button>
			</form>
<!---REGISTER--->
			<form action="backend/register.php" method="POST" id="register" name="reg" class="input-group" onsubmit="return registerValidate()">
				<input type="text" id="emri" name="emri" class="input-field" placeholder="Emri">
				<input type="text" id="mbiemri" name="mbiemri" class="input-field"  placeholder="Mbiemri">
				<input type="text" id="mail" name="mail" class="input-field"  placeholder="Email">
